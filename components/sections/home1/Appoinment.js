                                ...
                                <ul>
                                    <li className="wow animated fadeInLeft" data-wow-delay="0.1s">
                                        <div className="inner">
                                            ...
                                            {/* 62-14-8A,Ground floor,Krishna veni Road, Ramalingeswara nagar,Krishnalanka,Vijayawada, Andhra Pradesh - 520013 */}

                                            <div className="content-box">
                                                <h2>Location</h2>
                                                <p>62-14-8A,Ground floor,Krishna veni Road</p>
                                                <p>Ramalingeswara nagar,Krishnalanka</p>
                                                <p>Vijayawada, AndhraPradesh</p>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li className="wow animated fadeInLeft" data-wow-delay="0.3s">
                                        <div className="inner">
                                            ...
                                            <div className="content-box">
                                                <h2>Call us</h2>
                                                <p><Link href="tel:+91 9182423372">+91 9182423372</Link></p>
                                                <p><Link href="tel:+91 9281423372">+91 9281423372</Link></p>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
