    ...
    return (
        ...
        <section className="main-slider-one">
            <Swiper {...swiperOptions} className="main-slider__carousel owl-carousel owl-theme">
                    ...
                    <div className="container">
                        <div className="main-slider-one__content">
                            ...
                            <div className="title-box">
                                <h2>Care You Can Trust<br/> Safety You Can Feel.</h2>
                            </div>

                            <div className="text-box">
                                <p>Expertly crafted safety nets that blend strength with elegance, providing reliable protection. <br/>
                                    Designed for lasting safety and complete peace of mind. </p>
                            </div>
                ...
                <div className="main-slider-one__single">
                    {/* <div className="main-slider-one__bg"
                        style={{ backgroundImage: ' url(assets/images/nets/inv10.jpg)' }}></div> */}
                    {/* <div className="shape1"><img src="assets/images/shapes/slider-v1-shape1.png" alt=""/></div>
                    <div className="shape2"><img src="assets/images/shapes/slider-v1-shape2.png" alt=""/></div>
                    <div className="main-slider-one__img2"><img src="assets/images/nets/slider/slider-v1-img2.png" alt=""/></div> */}
                    <div className="container">
                        <div className="main-slider-one__content">
                            <div className="tagline">
                            ...
                            <div className="title-box">
                                <h2>Secure Today<br/> Safe Tomorrow</h2>
                            </div>
